prompt --application/shared_components/user_interface/lovs/lov_rad_discharge_discharge_order
begin
--   Manifest
--     LOV_RAD_DISCHARGE_DISCHARGE_ORDER
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(19523610404877680)
,p_lov_name=>'LOV_RAD_DISCHARGE_DISCHARGE_ORDER'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(19538221173924530)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(19539084144924531)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(19538697936924530)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(19539428211924531)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(19539874686924531)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(19540264737924531)
