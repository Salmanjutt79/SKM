prompt --application/shared_components/user_interface/lovs/lov_rad_hdr_phy_special_instr
begin
--   Manifest
--     LOV_RAD_HDR_PHY_SPECIAL_INSTR
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(23348372558684205)
,p_lov_name=>'LOV_RAD_HDR_PHY_SPECIAL_INSTR'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(23348755646688620)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(23349182803688620)
