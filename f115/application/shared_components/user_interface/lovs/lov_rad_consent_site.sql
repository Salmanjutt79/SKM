prompt --application/shared_components/user_interface/lovs/lov_rad_consent_site
begin
--   Manifest
--     LOV_RAD_CONSENT_SITE
--   Manifest End
...
wwv_flow_imp_shared.create_list_of_values(
 p_id=>wwv_flow_imp.id(86602792100875808)
,p_lov_name=>'LOV_RAD_CONSENT_SITE'
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(86603050452875809)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(278596384413075418)
,p_query_column_name=>'RADIATION_START_DATE'
,p_heading=>'Radiation Start Date'
,p_display_sequence=>2
,p_data_type=>'DATE'
);
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(86603498842875809)
...
wwv_flow_imp_shared.create_list_of_values_cols(
 p_id=>wwv_flow_imp.id(278598058123080019)
