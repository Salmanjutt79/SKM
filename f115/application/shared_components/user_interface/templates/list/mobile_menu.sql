prompt --application/shared_components/user_interface/templates/list/mobile_menu
begin
--   Manifest
--     REGION TEMPLATE: MOBILE_MENU
--   Manifest End
...
wwv_flow_imp_shared.create_list_template(
 p_id=>wwv_flow_imp.id(385339618391493367)
,p_list_template_current=>'<li data-current="true" data-id="#A01#" data-disabled="#A02#" data-icon="#ICON_CSS_CLASSES#" data-shortcut="#A05#"><a href="#LINK#" title="#A04#" target="#A06#">#TEXT_ESC_SC#</a></li>'
,p_list_template_noncurrent=>'<li data-id="#A01#" data-disabled="#A02#" data-icon="#ICON_CSS_CLASSES#" data-shortcut="#A05#"><a href="#LINK#" title="#A04#" target="#A06#">#TEXT_ESC_SC#</a></li>'
,p_list_template_name=>'Mobile Menu'
,p_internal_name=>'MOBILE_MENU'
,p_theme_id=>101
,p_theme_class_id=>6
...
,p_reference_id=>167182680255526950
);
