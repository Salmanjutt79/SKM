...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(173422706534455514)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74019305075256170)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74019823989256171)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74020354006256171)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74020872011256171)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74021392126256171)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74021819998256171)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74022341053256171)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74022866932256172)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74023369164256172)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74023822577256172)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(74024370958256172)
,p_plug_template_id=>wwv_flow_imp.id(173422706534455514)
,p_name=>'Sub Regions'
