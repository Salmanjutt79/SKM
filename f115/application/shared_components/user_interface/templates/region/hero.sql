...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14520154668908241)
,p_layout=>'TABLE'
...
,p_reference_id=>72049754242197857
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73959814257256144)
,p_plug_template_id=>wwv_flow_imp.id(14520154668908241)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73960361390256144)
,p_plug_template_id=>wwv_flow_imp.id(14520154668908241)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73960886654256145)
,p_plug_template_id=>wwv_flow_imp.id(14520154668908241)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73961348861256145)
,p_plug_template_id=>wwv_flow_imp.id(14520154668908241)
,p_name=>'Sub Regions'
