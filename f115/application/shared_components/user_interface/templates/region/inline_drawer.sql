...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14527905580908244)
,p_layout=>'TABLE'
...
,p_reference_id=>72057557823197870
,p_translate_this_template=>'N'
);
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73980653180256153)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73981102129256154)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73981658728256154)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73982198105256154)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73982606315256154)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73983103604256154)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73983668102256155)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(73984137681256155)
,p_plug_template_id=>wwv_flow_imp.id(14527905580908244)
,p_name=>'Sub Regions'
