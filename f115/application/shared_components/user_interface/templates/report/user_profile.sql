...
wwv_flow_imp_shared.create_row_template(
 p_id=>wwv_flow_imp.id(77312025059002056)
...
'        <img src="#IMAGE#" height="64" width="64" class="a-Header-photo" alt="Profile image for user #ID#" onerror="this.src=''#WORKSPACE_FILES#user_blank.png''">',
'      </span>',
