prompt --application/shared_components/security/authorizations/is_insert_allowed
begin
--   Manifest
--     SECURITY SCHEME: IS_INSERT_ALLOWED
--   Manifest End
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(27037036196527646)
,p_name=>'IS_INSERT_ALLOWED'
...
'begin',
'  -- Call the function',
'  v_allowed := security.pkg_login_apex.F_CHECK_PAGE_INSERT(p_page_id     => :app_page_id,',
'                                                             app_id        => :app_id,',
