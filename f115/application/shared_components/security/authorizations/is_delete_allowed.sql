prompt --application/shared_components/security/authorizations/is_delete_allowed
begin
--   Manifest
--     SECURITY SCHEME: IS_DELETE_ALLOWED
--   Manifest End
...
wwv_flow_imp_shared.create_security_scheme(
 p_id=>wwv_flow_imp.id(27036808146527646)
,p_name=>'IS_DELETE_ALLOWED'
...
'begin',
'  -- Call the function',
'  v_allowed := security.pkg_login_apex.F_CHECK_PAGE_DELETE(p_page_id     => :app_page_id,',
'                                                             app_id        => :app_id,',
